...
expression:
  ...
  | IDENT                                                             {$$ = newIdent($1);}
  | '(' expression ')'                                                {$$ = $2;}
  | IDENT '(' expressions ')'                                         {$$ = newOperation(IDENT,2,newIdent($1),$3);}
...
arguments:
  /* Rien */
  | IDENT                                                             {$$ = newIdent($1);}
  | IDENT ',' arguments                                               {$$ = newOperation(',',2,newIdent($1),$3);}
  | IDENT '=' expression                                              {$$ = newOperation('=',2,newIdent($1),$3);}
  | IDENT '=' expression ',' arguments                                {$$ = newOperation(',',3,newIdent($1),$3,$5);}
  ;
